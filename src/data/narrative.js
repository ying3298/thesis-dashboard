    ...
    versions: [
      {
        ...
        isCurrent: true,
        beats: {
          onceUponATime: 'People who move abroad for study or career must live apart from their parents\u2014and most assume that distance is simply a constraint on connection.',
          everyDay: 'They try to bridge the gap with instant messages, video calls, and real-time tools\u2014and this becomes the default way people think about staying close across distance.',
          untilOneDay: 'Through stories from different families, I discovered that the gap and distance can actually be celebrated\u2014and are something worth designing for.',
          ...
          untilFinally: 'People gain meaningful connection because of the distance and gap\u2014not despite it.',
          andEverSinceThen: 'They come to see asynchronous communication as a way to create unique memories and experiences with family\u2014living together across time zones.',
        },
      },
    ],
  },
